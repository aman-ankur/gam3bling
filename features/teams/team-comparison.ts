...
const TEAM_PROFILE_BY_CODE: Record<string, TeamProfile> = {
  ...
  BIH: profile(72, "UEFA", "Group stage"),
  BRA: profile(5, "CONMEBOL", "Winners"),
  CAN: profile(31, "CONCACAF", "Group stage"),
  ...
  CZE: profile(44, "UEFA", "Runners-up"),
  ...
  KOR: profile(23, "AFC", "Fourth place"),
  KSA: profile(58, "AFC", "Round of 16"),
  MAR: profile(12, "CAF", "Fourth place"),
  MEX: profile(17, "CONCACAF", "Quarterfinals"),
  ...
  PAR: profile(43, "CONMEBOL", "Quarterfinals"),
  POR: profile(6, "UEFA", "Third place"),
  QAT: profile(55, "AFC", "Group stage"),
  RSA: profile(59, "CAF", "Group stage"),
  SCO: profile(39, "UEFA", "Group stage"),
  SEN: profile(19, "CAF", "Quarterfinals"),
  SUI: profile(14, "UEFA", "Quarterfinals"),
  ...
  USA: profile(16, "CONCACAF", "Third place"),
